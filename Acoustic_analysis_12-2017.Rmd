...
```{r plot_depth_dist_by_region_boxplot, echo = FALSE, fig.width=8, fig.height=21}
...
#   g <- acousticdata10 %>%
#     filter(Layer == lyr) %>%
#     ggplot(aes(cpoly, Sv_mean, fill = Layer)) + 
...
#     ggtitle("Proportion of NASC in each vertical 10m Layer (Layer 1 = 10-20m)")+
